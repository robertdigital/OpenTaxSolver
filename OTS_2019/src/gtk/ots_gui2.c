...
char program_names[30][100] =
	{
	 ...
	 "taxsolve_US_8829",			/* 2 */
	 "taxsolve_CA_540_2019",		/* 3 */
	 "taxsolve_NC_D400_2019",		/* 4 */
	 "taxsolve_NJ_1040_2019",		/* 5 */
	 "taxsolve_OH_IT1040_2019",		/* 6 */
	 "taxsolve_PA_40_2019",			/* 7 */
	 "taxsolve_VA_760_2019",		/* 8 */
...
int main(int argc, char *argv[] )
{
 ...
 y = 105;
 make_sized_label( mpanel, winwidth / 2 - 60, y, "2019 Tax Year", 11.0 );
 y = y + 35;
